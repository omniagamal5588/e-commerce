...
const LoginPage = () => {
    const [email, password , onChangeEmail ,onChangePassword ,onSubmit,isPress,loading] = loginUserHook();
   return (
        <Container style={{ minHeight: "690px" }}>
            <Row className="py-5 d-flex justify-content-center ">
                <Col sm="12" className="d-flex flex-column ">
                    ...
                    {isPress === true ? (loading === true ? (<Spinner animation="border" role="status"> </Spinner>) : null) : null}
