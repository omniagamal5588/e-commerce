...
import { creatProduct, getOneProduct } from '../../redux/actions/productAction';
import notify from '../useNotifcation';
import { useSelector, useDispatch } from 'react-redux'
import { getAllCategory } from '../../redux/actions/categoryAction'
import { getAllBrand } from './../../redux/actions/brandAction';
import { updateProductData } from '../../redux/actions/productAction';
...
const AdminEditProductsHook = (id) => {
    ...
    const handelSubmit = async (e) => {
        ...
        setTimeout(async () => {
            setLoading(true)
            await dispatch(updateProductData(id, formData))
            setLoading(false)
        }, 1000);
